...
#        super(API, self).__init__(**kwargs)
    ...
    def ensure_create_instance(self, context, instance_id):
        LOG.debug("Triggering worker app server to ensure instance created: %s.", instance_id)
        instance = utils.get_instance(instance_id)
        rpc.cast(context, 'work',
                 {"create-instance":{"id": instance_id}})
